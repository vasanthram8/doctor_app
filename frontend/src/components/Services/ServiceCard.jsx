...
const ServiceCard = ({item, index}) => {
  ...
  return (
    ...
    <span className='w-[44px] h-[44px] flex items-center justify-center text-[18px] leading-[30px] font-[600]' style={{background: `${bgColor}`, color: `${textColor}`, borderRadius:"6px 0 0 px",}}>
        {index + 1}
    </span>
    </div>    
    </div>

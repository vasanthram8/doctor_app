...
const Profile = ({doctorData}) => {
    ...
    const hadleQualificationChange = (event, index) =>{
    ...
    const hadleExperienceChange = (event, index) =>{
    ...
    const hadleTimeSlotChange = (event, index) =>{
                        ...
                        <div className="grid grid-cols-2 gap-5">
                            <div>
                                ...
                                <input
                                 ...
                                 className="form_input"
                                 onChange={e=> hadleQualificationChange(e, index)}
                                />
                            </div>
                            <div>
                        ...
                        <div className="grid grid-cols-2 gap-5">
                            <div>
                                ...
                                <input
                                 ...
                                 value={item.startingDate}
                                 className="form_input"
                                 onChange={e=> hadleExperienceChange(e, index)}
                                />
                            </div>
                            <div>
                                <p className="form_label">Ending Date*</p>
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 mb-[30px] gap-5">
                            <div>
                                ...
                                <select name="day"
                                 value={item.day}
                                 className="form_input py-3.5"
                                 onChange={e=> hadleTimeSlotChange(e, index)}
                                 >
                                    <option value="">Select</option>
                            ...
                            <div className="flex items-center">
                                <button onClick={e=> deleteTimeSlot(e, index)} className="bg-red-600 p-2 rounded-full text-white text-[18px] mt-2 cursor-pointer mt-6">
                                <AiOutlineDelete />
                                </button>
                            </div>
                        </div>        
